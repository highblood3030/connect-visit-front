...
export default function Home() {
  return (
    <div className="flex flex-col md:flex-row h-screen overflow-hidden">
      ...
      <div className="w-full md:w-[27%] bg-[#25B4AB] relative overflow-hidden min-h-[40vh] md:min-h-0 flex justify-center items-center">
        ...
        {/* Floating Help Icon */}
        <div className="absolute top-4 right-4 w-8 h-8 md:w-10 md:h-10 rounded-full bg-white/20 backdrop-blur-md flex justify-center items-center shadow-lg animate-float">
